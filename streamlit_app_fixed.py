...
from clinical.pharmaco import (
    ...
    taradyl_im, diclofenac_im,  # Nouveaux médicaments IM
)
...
try:
    ...
    with st.sidebar:
        ...
        # ── Antécédents structurés (cases à cocher) — DÉPLACÉ DANS EXPANDER ──────────────────────────
        with st.sidebar.expander("📋 Antécédents (ATCD)", expanded=False):
        ...
        with st.sidebar.expander("⚠️ Facteurs favorisants", expanded=False):
        ...
        with st.sidebar.expander("💊 Traitements en cours", expanded=False):
        ...
        # ── Alertes pharmacovigilance — DÉPLACÉ DANS EXPANDER ──────────────────
        with st.sidebar.expander("🚨 Alertes Pharmacovigilance", expanded=True):
    ...
    # ═══════════════════════════════════════════════════════════════════════════════
    # ONGLET PRINCIPAL — Restructuré selon les exigences
    # ═══════════════════════════════════════════════════════════════════════════════
    T = st.tabs(["📊 Évaluation & Triage", "🧬 Scores Cliniques", "💊 Pharmacopée Adaptative", "📋 Synthèse"])
